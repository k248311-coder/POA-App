...
export function TeamMemberLayout({ children, currentPage, onNavigate, onLogout, projectName, onSwitchProject }: TeamMemberLayoutProps) {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  const navigation = [
    { name: "Dashboard", icon: LayoutDashboard, page: "dashboard" },
    { name: "My Stories", icon: FileText, page: "mystories" },
